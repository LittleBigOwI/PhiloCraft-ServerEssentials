    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        if (sender instanceof Player && label.equalsIgnoreCase("tpahere")) {
            if (args.length == 1) {
                ...
                TextComponent context = new TextComponent(ChatColor.translateAlternateColorCodes('&', "&6" + player.getName() + "&e wants to teleport you "));
                ...
                accept.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, "/tpaccept nothere"));
